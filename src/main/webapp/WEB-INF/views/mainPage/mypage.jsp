	...
	<div class="body-wrap container col-12 column-row">
		...
		<c:choose>
								...
								<div class="row container d-flex mt-2">
									...
									<div class="container column-row col-8 m-0 p-0">
										<div class="container d-flex">
											<input id="update_div" class="mypage-name col-10 m-0 p-0" onkeyup="enterkey()" value="${sessionScope.session_nickname}" readonly='readonly' />
			...
			<div class="login_alert">
				<img src="${path}/resources/images/food_emoji.png">
				<p>로그인 시 이용할 수 있는 페이지입니다.</p>
				<img src="${path}/resources/images/food_emoji1.png">
				</div>
