			...
			<div class="shop-detail-wrap col-12 mt-2 ms-3 column-row"
				...
				<div class="row">
					<div class="shop-detail-header container d-flex">
							...
							<div class="shop-info-body column-row p-4">
								<div class="row">
									<div class="shop-info d-flex">
										<div class="shop-name col-7 pe-3">
											<!-- 업소 이름 -->
											<p id="shop-name">
												<c:out value="${adto.foodstore_name}" />
											</p>
										</div>
								...
								<div class="shop-info-detail d-flex mt-1">
									<div class="shop-address">
										<p id="shop-address">
											<c:out value="${adto.address}" />
										</p>
										<p id="shop-phone">
											<c:out value="${adto.store_num}" />
										</p>
									</div>
									<div class="shop-etc">
										<p id="shop-close">
											<c:out value="${adto.working_time}" />
										</p>
									</div>
								</div>
							</div>
						...
						<%-- shop-right --%>
						<div
							class="col-4 container shop-right column-row py-2 px-0 ms-2 me-0">
							...
							<div class="shop-menu column-low mt-3 p-3" id="shop-menu">
								...
								<div class="d-flex">
									<div class="col-8" id="shop-menu-detail">
										<c:forTokens items="${adto.menu_NameSearch}" delims=","
											var="menu">
											<p id="shop-menu-detail">${menu}</p>
										</c:forTokens>
									</div>
									<div class="col-4" id="shop-menu-price">
										<c:forTokens items="${adto.menu_PriceSearch}" delims="/"
											var="price">
											<p id="shop-price-detail">${price}원</p>
										</c:forTokens>
									</div>
								</div>
							</div>
